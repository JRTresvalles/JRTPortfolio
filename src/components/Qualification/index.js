          ...
          <div className="qualification__sections">
            ...
            >
              ...
              <div className="qualification__data">
               ...
               <div>
                  <h3 className="qualification__title">Funnel & Website Designer</h3>
                  <span className="qualification__subtitle">Website Factory</span>
                  <div className="qualification__calendar">
                    <i className="bx bx-calendar"></i>
                    2025-2026
                  </div>
              ...
              <div className="qualification__data">
                <div>
                  <h3 className="qualification__title">All Around Graphic Designer</h3>
                  <span className="qualification__subtitle">KOR CREW</span>
                  <div className="qualification__calendar">
                    <i className="bx bx-calendar"></i>
                    2024-2026
                  </div>
              ...
              <div className="qualification__data">
                ...
                <div>
                  <h3 className="qualification__title">Frontend Developer & UX/UI Designer</h3>
                  <span className="qualification__subtitle">ApproveMe LLC</span>
                  <div className="qualification__calendar">
                    <i className="bx bx-calendar"></i>
                    2023 - 2025
                  </div>
              ...
              <div className="qualification__data">
                <div>
                  ...
                  <span className="qualification__subtitle">Biodegradable Golf Balls</span>
                  <div className="qualification__calendar">
                    <i className="bx bx-calendar"></i>
                    2022
                  </div>
